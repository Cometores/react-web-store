...
const Gallery = () => {
	return (
		<div className={styles.Gallery}>
			<MyImage className={styles.item1} width="150" scr="https://cdn.shopify.com/s/files/1/1265/2145/files/Samples.webp?v=1676564977&width=150" />
			...
			<MyImage className={styles.item4} width="400" scr="https://cdn.shopify.com/s/files/1/1265/2145/files/CafFree.webp?v=1676562761&width=400" />
